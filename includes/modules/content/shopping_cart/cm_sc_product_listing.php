      ...
      if ($cart->count_contents() > 0) {
        $any_out_of_stock = 0;
	  	  $products = $cart->get_products();
     		...
     		$products_name = tep_draw_form('cart_quantity', tep_href_link(FILENAME_SHOPPING_CART, 'action=update_product'));
        ...
        $products_name = MODULE_CONTENT_SC_PRODUCT_LISTING_TEXT_CART_EMPTY;
      }
